...
import tud.st.bpel.history.BpelPrologHistoryListener;
import tud.st.bpel.history.BpelLogHistoryListener;
...
public class ODEServer {
    ...
    public void init(String contextPath, AxisConfiguration axisConf) throws ServletException {
        ...
        try {
            ...
            __log.debug("HISTORY: Initializing BPEL history...");
    ...
    // AL: register history listeners
    private void registerHistoryListeners() {
